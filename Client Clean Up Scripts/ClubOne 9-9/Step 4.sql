...
insert into @invoicesToRemove (txInvoiceId) values (663060)
insert into @invoicesToRemove (txInvoiceId) values (662719)
insert into @invoicesToRemove (txInvoiceId) values (662677)
insert into @invoicesToRemove (txInvoiceId) values (662575)
insert into @invoicesToRemove (txInvoiceId) values (661203)
--insert into @invoicesToRemove (txInvoiceId) values (663101)
insert into @invoicesToRemove (txInvoiceId) values (660898)
insert into @invoicesToRemove (txInvoiceId) values (665176) 
insert into @invoicesToRemove (txInvoiceId) values (660788)
insert into @invoicesToRemove (txInvoiceId) values (661623)
insert into @invoicesToRemove (txInvoiceId) values (662614)
insert into @invoicesToRemove (txInvoiceId) values (665618)
insert into @invoicesToRemove (txInvoiceId) values (660803)
insert into @invoicesToRemove (txInvoiceId) values (663065)
insert into @invoicesToRemove (txInvoiceId) values (662723)
insert into @invoicesToRemove (txInvoiceId) values (662682)
insert into @invoicesToRemove (txInvoiceId) values (662580)
insert into @invoicesToRemove (txInvoiceId) values (661206)
--insert into @invoicesToRemove (txInvoiceId) values (663109)
insert into @invoicesToRemove (txInvoiceId) values (660900)
insert into @invoicesToRemove (txInvoiceId) values (665179)
insert into @invoicesToRemove (txInvoiceId) values (660792)
insert into @invoicesToRemove (txInvoiceId) values (661628)
insert into @invoicesToRemove (txInvoiceId) values (662617)
insert into @invoicesToRemove (txInvoiceId) values (665624)
insert into @invoicesToRemove (txInvoiceId) values (660808)
